...
const statusOptions: DropdownOption[] = [
  {
    ...
    description: "Ready for a new renter",
  },
  {
    value: "occupied",
    label: "Occupied",
  ...
  },
  {
    ...
    description: "Maintenance or temporarily unavailable",
  },
];
    ...
    <main>
      ...
      <section className="availabilityHero">
        <div>
          ...
          <p>
            Manage unit status from one place and keep marketplace availability
            aligned with your real inventory.
          </p>
        </div>
      ...
      <section className="availabilityPanel">
        <header>
          ...
          <button type="button" className="availabilityAction">
            + Add unit
          </button>
        </header>
          ...
          {units.map((unit) => (
            <article className="unitRow" key={unit.unit}>
              ...
              <button
                type="button"
                className="unitMenu"
                aria-label={"More actions for " + unit.unit}
              >
                •••
              </button>
            </article>
