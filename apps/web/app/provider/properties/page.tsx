    ...
    <main>
      ...
      <section className="workspaceHero">
        <div>
          ...
          <p>Keep the buildings and rental spaces behind your listings accurate and easy to manage.</p>
        </div>
        <Link className="workspacePrimary" href="/provider/properties/new">+ Add property</Link>
      </section>

      <section className="workspaceStats">
        <div><strong>2</strong><span>Properties</span></div>
        <div><strong>18</strong><span>Total units</span></div>
        <div><strong>13</strong><span>Available units</span></div>
        <div><strong>72%</strong><span>Occupancy</span></div>
      </section>
      ...
      <section className="propertyGrid">
        {properties.map(([name, location, type, units, available]) => (
          <article className="propertyWorkspaceCard" key={name}>
            <div className="propertyVisual"><span>{type}</span></div>
            <div className="propertyWorkspaceBody">
              ...
              <Link className="rowAction" href="/provider/properties">Manage property →</Link>
            </div>
          </article>
        ))}
      </section>
