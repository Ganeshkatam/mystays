...
const inquiries = [
  {
    ...
    status: 'New',
    time: '12 min ago',
    message: 'Could you share more details about availability and the move-in process?',
  },
  {
    id: 'inq-02',
    initials: 'NS',
    ...
    <main>
      ...
      <section className="inquiryHero">
        <div>
          ...
          <p>Stay on top of renter interest, answer questions, and keep every inquiry attached to the right listing.</p>
        </div>
          ...
          <article className="inquiryCard" key={inquiry.id}>
            ...
            <div className="inquiryMain">
              <div className="inquiryTop">
                <div>
                  <span className="inquiryListing">{inquiry.listing} · {inquiry.location}</span>
                  <h2>{inquiry.name}</h2>
                </div>
              ...
              <div className="inquiryBottom">
                <span className={'inquiryStatus status' + inquiry.status.replace(/\s/g, '')}>{inquiry.status}</span>
                <div>
                  <button className="textButton">View conversation</button>
                  {inquiry.status !== 'Replied' && <button className="replyButton">Reply</button>}
                </div>
              </div>
            </div>
          </article>
