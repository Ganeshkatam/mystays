  ...
  return (
    <main>
      ...
      <section className="providerHero">
        ...
        <p>Review new interest and respond from one place.</p>
      </section>
      <section className="tableCard">
        <article className="propertyCard">
          <span>SUBMITTED · Sunlit 2BHK</span>
          <h2>Interested in viewing this home</h2>
          <p>Could you share more details about availability and the move-in process?</p>
          <button className="primary">Mark viewed</button>
